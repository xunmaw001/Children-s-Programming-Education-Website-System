		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.xuefei" type="text" name="xuefei" id="xuefei" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="kechengbiao" id="kechengbiao">请输入课程表</textarea>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
