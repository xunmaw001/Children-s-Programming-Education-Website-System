			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="fengmianUpload">
								<i class="layui-icon">&#xe67c;</i>上传封面
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">学习资料：</label>
						<div class="layui-input-inline" style="line-height: 50px;">
                            ...
                            <button type="button" class="layui-btn btn-theme" id="xuexiziliaoUpload">
								<i class="layui-icon">&#xe67c;</i>上传学习资料
							</button>
							<a download="学习资料" :href="detail.xuexiziliao">点击下载学习资料</a>
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
