...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in remenzixunRecommend" v-bind:key="index">
                <a target="_self" :href="'../remenzixun/detail.jsp?id='+item.id">
                  <div class="posi-img">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in chengguozhanshiList" v-bind:key="index">
                <a target="_self" :href="'../chengguozhanshi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.fengmian?item.fengmian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`remenzixun/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.remenzixunRecommend = res.data.list;
      });
      ...
      http.request(`chengguozhanshi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.chengguozhanshiList = res.data.list;
      });
