					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">学习资料列表</li>
							</ol>
						</div>
					</div>
				</div>
			...
			row.appendChild(checkbox)
				  ...
				  fengmianCell.appendChild(fengmianImg);
									...
									row.appendChild(fengmianCell);
				            				var xuexiziliaoCell  = document.createElement('td');

												  var xuexiziliaoFile = document.createElement('button');
				  xuexiziliaoFile.innerHTML = '下载';
				  var xuexiziliaoFileAttr = "download('" + item.xuexiziliao + "')"
				  xuexiziliaoFile.setAttribute('onclick',xuexiziliaoFileAttr);
                  xuexiziliaoCell.appendChild(xuexiziliaoFile);

                
									row.appendChild(xuexiziliaoCell);
