					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">学习资料管理</li>
								<li class="breadcrumb-item active">编辑学习资料</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input name="fengmian" id="fengmian-input" type="hidden">
											...
											<div class="form-group col-md-6">
										<label>学习资料</label>	
										<input name="file" type="file" class="form-control-file" id="xuexiziliaoupload">
										<label id="xuexiziliaoFileName"></label>
										<input name="xuexiziliao" id="xuexiziliao-input" type="hidden">
									</div>
													<div class="form-group col-md-6">
										<label>发布时间</label>
		...
		function upload(){
						...
						dataType: 'json',
							...
							$("#fengmianImg").attr("src",baseUrl+"upload/"+data.result.file);								
																...
																$('#xuexiziliaoupload').fileupload({
						url: baseUrl + 'file/upload',
						headers:{ token: window.sessionStorage.getItem("token")},
						dataType: 'json',
						done: function (e, data) {							
							document.getElementById('xuexiziliao-input').setAttribute('value',baseUrl+'file/download?fileName='+data.result.file);
							if(document.getElementById('xuexiziliaoFileName') != null){
								document.getElementById('xuexiziliaoFileName').innerHTML = "上传成功!";
							}		
							$("#xuexiziliaoImg").attr("src",data.result.file);												
						}
					});
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#biaoti").val(ruleForm.biaoti);	
																...
																$("#xuexiziliao-input").val(ruleForm.xuexiziliao);
					$("#xuexiziliaoFileName").html(ruleForm.xuexiziliao);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$("#fengmian-input").val(res.data.fengmian);
												...
												if(res.data != null && res.data != '' && res.data.xuexiziliao != null && res.data.xuexiziliao != ''){

															$("#xuexiziliao-input").val(res.data.xuexiziliao);
								$('#xuexiziliaoFileName').val(res.data.xuexiziliao)
													}
