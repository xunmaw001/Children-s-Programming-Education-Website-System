												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('kechengbianhao')">课程编号<i id="kechengbianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('kechengbiao')">课程表<i id="kechengbiaoIcon" class="fa fa-sort"></i></th>
							...
							var kechengbianhaoCell  = document.createElement('td');
									...
									row.appendChild(shangkedidianCell);
				            				var kechengbiaoCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.kechengbiao && item.kechengbiao.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.kechengbiao.indexOf('<img');
					var endIndex = item.kechengbiao.indexOf('>');				
					kechengbiaoCell.innerHTML = item.kechengbiao.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
				  	 if(item.kechengbiao != null && item.kechengbiao != "" && item.kechengbiao.length >= 11){
				  		kechengbiaoCell.innerHTML = item.kechengbiao.substring(0, 10) + "..."; 
				  	}else{
				  		kechengbiaoCell.innerHTML = item.kechengbiao;
				 	}
				  }
				  

                
									row.appendChild(kechengbiaoCell);
